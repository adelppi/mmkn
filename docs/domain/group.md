...
- 起きないこと：
  ...
  - Group・Member は作られない
  - 外部アカウントは連携されない（後述「外部アカウントを連携する」）

### ログインする [確定]

- 前提条件：入力された識別子の User が存在し、本人であることが確かめられること
...
- 起きないこと：
  ...
  - Member でない人に、そのグループの記録・差額・清算案の中身が見えることはない
...
- ログイン識別子を何にし、本人であることをどう確かめるかは `adr/0012-login.md` を正とする。ドメインとして要求するのは「mmkn 全体で重複しないこと」「本人であることが確かめられること」までで、手段は規定しない。[確定]

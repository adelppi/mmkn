...
<!-- 0003 がスタック全体の親。0004〜0015 は 0003 を前提とする個別決定。0008 は 0004 の内側を、0009 は 0008 を前提に Web の画面を埋める。0010 は 0004 の「テスト」を、0011 は 0004・0005・0006・0010 が個別に要求している CI・リリースの手順を埋める。0012 は 0003 の「認証」の中身を、0013 は domain/money.md が要求するデータの出どころを、0014・0015 は運用でしか現れない穴（障害の気づき方・データの失われ方）を埋める。0001 はスタックに依存しない決定。 -->

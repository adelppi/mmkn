...
export async function GET(request: NextRequest) {
  ...
  if (code === null) return to(route.login())
  ...
  if (completed.kind === 'rejected') return to(route.login())
